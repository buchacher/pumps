...
# Under-sample - chosen technique for task 6
...
# Define (limited) params for grid search
params = {
    'hidden_layer_sizes': [(50, 50), (100, 100), (200, 200), (400, 400), (800, 800)],
    'activation': ['relu', 'tanh'],
    'learning_rate_init': [0.1, 0.01, 0.001],
}

grid_clf = GridSearchCV(model, params, scoring='accuracy', cv=3, verbose=4)
...
train_prc.ax_.set_title("Task 6 Training Precision-Recall Curve")
train_prc.plot()
plt.show()

# Save the built classifier (incl. preprocessor)
with open('saved-models/task6_model.pkl', 'wb') as f:
    pickle.dump(clf, f)
